/*
 * hyperv_api_common.c: common core driver functions for Hyper-V hosts
 *
 ...
 */
static int
hyperv_GENERIC_InvokeMethodXml(hypervPrivate *priv, WsXmlDocH xmlDocRoot,
        ...
        WsXmlDocH *res)
{
    ...
    Msvm_ConcreteJob_V_GENERIC_ *job = NULL;
    int jobState = -1;
    ...
    if (returnCode == CIM_RETURNCODE_TRANSITION_STARTED) {
        ...
        /* Get Msvm_ConcreteJob_V_GENERIC_ object */
        ...
        while (!completed) {
            virBufferAddLit(&query, MSVM_CONCRETEJOB_V_GENERIC__WQL_SELECT);
            virBufferAsprintf(&query, "where InstanceID = \"%s\"", instanceID);

            if (hyperv_GENERIC_GetMsvmConcreteJobList(priv, &query, &job) < 0) {
                goto cleanup;
            }
            ...
            switch(jobState) {
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_NEW:
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_STARTING:
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_RUNNING:
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_SHUTTING_DOWN:
                    hypervFreeObject(priv, (hypervObject *) job);
                    job = NULL;
                    usleep(100 * 1000); /* sleep 100 ms */
                    continue;
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_COMPLETED:
                    completed = true;
                    break;
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_TERMINATED:
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_KILLED:
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_EXCEPTION:
                case MSVM_CONCRETEJOB_V_GENERIC__JOBSTATE_SERVICE:
                    goto cleanup;
                default:
                    virReportError(VIR_ERR_INTERNAL_ERROR,
...
static int
hyperv_GENERIC_InvokeMethod(hypervPrivate *priv, invokeXmlParam *param_t, int nbParameters,
        ...
        WsXmlDocH *res)
{
    ...
    /* invoke the method */
    if (hyperv_GENERIC_InvokeMethodXml(priv, doc, methodName, providerURI, selector,
                res) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
...
static int
hyperv_GENERIC_GetProcessorsByName(hypervPrivate *priv, const char *name,
...
static int
hyperv_GENERIC_GetActiveVirtualSystemList(hypervPrivate *priv,
        Msvm_ComputerSystem_V_GENERIC_ **computerSystemList)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;

    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_SELECT);
    virBufferAddLit(&query, "where ");
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_VIRTUAL);
    virBufferAddLit(&query, "and ");
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_ACTIVE);

    if (hyperv_GENERIC_GetMsvmComputerSystemList(priv, &query, computerSystemList) < 0) {
        goto cleanup;
    }
...
static int
hyperv_GENERIC_GetInactiveVirtualSystemList(hypervPrivate *priv,
        Msvm_ComputerSystem_V_GENERIC_ **list)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;
    ...
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_VIRTUAL);
    virBufferAddLit(&query, "and ");
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_INACTIVE);

    if (hyperv_GENERIC_GetMsvmComputerSystemList(priv, &query, list) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_GetPhysicalSystemList(hypervPrivate *priv,
        Win32_ComputerSystem **computerSystemList)
{
    ...
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_SELECT);
    virBufferAddLit(&query, "where ");
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_PHYSICAL);
...
static int
hyperv_GENERIC_GetVirtualSystemByID(hypervPrivate *priv, int id,
        Msvm_ComputerSystem_V_GENERIC_ **computerSystemList)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;
...
static int
hyperv_GENERIC_GetVirtualSystemByUUID(hypervPrivate *priv, const char *uuid,
        Msvm_ComputerSystem_V_GENERIC_ **computerSystemList)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;
...
static int
hyperv_GENERIC_GetVirtualSystemByName(hypervPrivate *priv, const char *name,
        Msvm_ComputerSystem_V_GENERIC_ **computerSystemList)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;
...
static int
hyperv_GENERIC_GetVSSDFromUUID(hypervPrivate *priv, const char *uuid,
        Msvm_VirtualSystemSettingData_V_GENERIC_ **data)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;

    /* Get Msvm_VirtualSystemSettingData_V_GENERIC_ */
    virBufferAsprintf(&query,
            "associators of "
    ...
    if (hyperv_GENERIC_GetMsvmVirtualSystemSettingDataList(priv, &query, data) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_GetProcSDByVSSDInstanceId(hypervPrivate *priv, const char *id,
        Msvm_ProcessorSettingData_V_GENERIC_ **data)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;

    /* Get Msvm_ProcessorSettingData_V_GENERIC_ */
    virBufferAsprintf(&query,
            "associators of "
    ...
    if (hyperv_GENERIC_GetMsvmProcessorSettingDataList(priv, &query, data) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_GetMemSDByVSSDInstanceId(hypervPrivate *priv, const char *id,
        Msvm_MemorySettingData_V_GENERIC_ **data)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;

    /* Get Msvm_MemorySettingData_V_GENERIC_ */
    virBufferAsprintf(&query,
            "associators of "
            "{Msvm_VirtualSystemSettingData.InstanceID=\"%s\"} "
            "where AssocClass = Msvm_VirtualSystemSettingDataComponent "
    ...
    if (hyperv_GENERIC_GetMsvmMemorySettingDataList(priv, &query, data) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_GetRASDByVSSDInstanceId(hypervPrivate *priv, const char *id,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ **data)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;
    ...
    if (hyperv_GENERIC_GetMsvmResourceAllocationSettingDataList(priv, &query, data) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_GetSyntheticEthernetPortSDByVSSDInstanceId(hypervPrivate *priv,
        const char *id, Msvm_SyntheticEthernetPortSettingData_V_GENERIC_ **out)
{
    int result = -1;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    ...
    if (hyperv_GENERIC_GetMsvmSyntheticEthernetPortSettingDataList(priv, &query,
                out) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_LookupHostSystemBiosUuid(hypervPrivate *priv, unsigned char *uuid)
{
...
static int
hyperv_GENERIC_GetHostSystem(hypervPrivate *priv, Msvm_ComputerSystem_V_GENERIC_ **system)
{
    virBuffer query = VIR_BUFFER_INITIALIZER;
    int result = -1;
    ...
    if (hyperv_GENERIC_GetMsvmComputerSystemList(priv, &query, system) < 0)
        goto cleanup;
...
static int
hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange(virDomainPtr domain,
                                                 int requestedState)
{
    int result = -1;
    ...
    char *instanceID = NULL;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    Msvm_ConcreteJob_V_GENERIC_ *concreteJob = NULL;
    bool completed = false;
    ...
    /* Invoke method */
    response = wsmc_action_invoke(priv->client, MSVM_COMPUTERSYSTEM_V_GENERIC__RESOURCE_URI,
    ...
    if (returnCode == CIM_RETURNCODE_TRANSITION_STARTED) {
        ...
        while (!completed) {
            ...
            if (hyperv_GENERIC_GetMsvmConcreteJobList(priv, &query, &concreteJob) < 0)
                goto cleanup;
...
static int
hyperv_GENERIC_MsvmComputerSystemEnabledStateToDomainState
  (Msvm_ComputerSystem_V_GENERIC_ *computerSystem)
{
    switch (computerSystem->data->EnabledState) {
      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_UNKNOWN:
        return VIR_DOMAIN_NOSTATE;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_ENABLED:
        return VIR_DOMAIN_RUNNING;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_DISABLED:
        return VIR_DOMAIN_SHUTOFF;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_PAUSED:
        return VIR_DOMAIN_PAUSED;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_SUSPENDED: /* managed save */
        return VIR_DOMAIN_SHUTOFF;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_STARTING:
      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_SNAPSHOTTING:
      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_SAVING:
        return VIR_DOMAIN_RUNNING;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_STOPPING:
        return VIR_DOMAIN_SHUTDOWN;

      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_PAUSING:
      case MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_RESUMING:
        return VIR_DOMAIN_RUNNING;
...
static bool
hyperv_GENERIC_IsMsvmComputerSystemActive(Msvm_ComputerSystem_V_GENERIC_ *computerSystem,
                                 bool *in_transition)
{
...
static int
hyperv_GENERIC_MsvmComputerSystemToDomain(virConnectPtr conn,
                                 Msvm_ComputerSystem_V_GENERIC_ *computerSystem,
                                 virDomainPtr *domain)
{
    ...
    *domain = virGetDomain(conn, computerSystem->data->ElementName, uuid);
    ...
    if (hyperv_GENERIC_IsMsvmComputerSystemActive(computerSystem, NULL)) {
...
static int
hyperv_GENERIC_MsvmComputerSystemFromDomain(virDomainPtr domain,
                                   Msvm_ComputerSystem_V_GENERIC_ **computerSystem)
{
    hypervPrivate *priv = domain->conn->privateData;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    ...
    if (hyperv_GENERIC_GetMsvmComputerSystemList(priv, &query, computerSystem) < 0)
        return -1;
...
virCapsPtr
hyperv_GENERIC_CapsInit(hypervPrivate *priv)
{
    ...
    if (hyperv_GENERIC_LookupHostSystemBiosUuid(priv, caps->host.host_uuid) < 0) {
        goto error;
    }
...
static int
hyperv_GENERIC_GetDeviceParentRasdFromDeviceId(const char *parentDeviceId,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *list,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ **out)
{
    int result = -1;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *entry = list;
...
static char *
hyperv_GENERIC_GetInstanceIDFromXMLResponse(WsXmlDocH response)
{
...
static int
hyperv_GENERIC_DomainDefParseIDEController(virDomainDefPtr def,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *ide ATTRIBUTE_UNUSED, int idx)
{
    int result = -1;
...
static int
hyperv_GENERIC_DomainDefParseSCSIController(virDomainDefPtr def,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *scsi ATTRIBUTE_UNUSED, int idx)
{
    int result = -1;
    virDomainControllerDefPtr ctrlr = NULL;
...
static int
hyperv_GENERIC_DomainDefParseIDEStorageExtent(virDomainDefPtr def, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ **ideControllers,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *disk_parent,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *disk_ctrlr)
{
    int i = 0;
    int result = -1;
    int ctrlr_idx = -1;
    ...
    for (i = 0; i < HYPERV_MAX_IDE_CONTROLLERS; i++) {
...
static int
hyperv_GENERIC_DomainDefParseSCSIStorageExtent(virDomainDefPtr def, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ **scsiControllers,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *disk_parent,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *disk_ctrlr)
{
    int i = 0;
...
static int
hyperv_GENERIC_DomainDefParseFloppyStorageExtent(virDomainDefPtr def, virDomainDiskDefPtr disk)
{
    int result = -1;
    /* Parse floppy drive */
...
static int
hyperv_GENERIC_DomainDefParseStorage(virDomainPtr domain, virDomainDefPtr def,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *rasd)
{
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *entry = rasd;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *disk_parent = NULL, *disk_ctrlr = NULL;
    ...
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *ideControllers[HYPERV_MAX_IDE_CONTROLLERS];
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *scsiControllers[HYPERV_MAX_SCSI_CONTROLLERS];

    while (entry != NULL) {
        switch (entry->data->ResourceType) {
            case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_IDE_CONTROLLER:
                ide_idx = entry->data->Address[0] - '0';
                ideControllers[ide_idx] = entry;
                if (hyperv_GENERIC_DomainDefParseIDEController(def, entry, ide_idx) < 0) {
                    virReportError(VIR_ERR_INTERNAL_ERROR, "Could not parse IDE controller");
                    goto cleanup;
                }
                break;
            case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_PARALLEL_SCSI_HBA:
                scsiControllers[scsi_idx++] = entry;
                if (hyperv_GENERIC_DomainDefParseSCSIController(def, entry, scsi_idx-1) < 0) {
    ...
    while (entry != NULL) {
        if (entry->data->ResourceType ==
                MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_STORAGE_EXTENT) {
            /* reset some vars */
            disk = NULL;
            conn = NULL;
            ...
            if (hyperv_GENERIC_GetDeviceParentRasdFromDeviceId(entry->data->Parent,
                        rasd, &disk_parent) < 0)
                goto cleanup;

            /* get associated controller */
            if (hyperv_GENERIC_GetDeviceParentRasdFromDeviceId(disk_parent->data->Parent,
                        rasd, &disk_ctrlr) < 0)
                goto cleanup;
            ...
            switch (disk_ctrlr->data->ResourceType) {
                case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_PARALLEL_SCSI_HBA:
                    if (hyperv_GENERIC_DomainDefParseSCSIStorageExtent(def, disk,
                            scsiControllers, disk_parent, disk_ctrlr) < 0) {
                        goto cleanup;
                    }
                    break;
                case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_IDE_CONTROLLER:
                    if (hyperv_GENERIC_DomainDefParseIDEStorageExtent(def, disk,
                                ideControllers, disk_parent, disk_ctrlr) < 0) {
                        goto cleanup;
                    }
                    break;
                case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_OTHER:
                    if (disk_parent->data->ResourceType ==
                            MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_FLOPPY) {
                        if (hyperv_GENERIC_DomainDefParseFloppyStorageExtent(def, disk) < 0) {
                            goto cleanup;
                        }
                ...
                MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_DISK) {
            ...
            if (STREQ(entry->data->ResourceSubType,
                ...
                /*
                 * Use regex to lift DeviceID of backing Msvm_DiskDrive_V_GENERIC_
                 * from hostResource
                 */
...
static int
hyperv_GENERIC_DomainDefParseSyntheticEthernetAdapter(virDomainDefPtr def,
        Msvm_SyntheticEthernetPortSettingData_V_GENERIC_ *net,
        hypervPrivate *priv)
{
    int result = -1;
    virDomainNetDefPtr ndef = NULL;
    Msvm_SwitchPort_V_GENERIC_ *switchPort = NULL;
    Msvm_VirtualSwitch_V_GENERIC_ *vSwitch = NULL;
    ...
    /* Now we retrieve the associated Msvm_SwitchPort_V_GENERIC_ and Msvm_VirtualSwitch_V_GENERIC_
    ...
    if (hyperv_GENERIC_GetMsvmSwitchPortList(priv, &query, &switchPort) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
    ...
    if (hyperv_GENERIC_GetMsvmVirtualSwitchList(priv, &query, &vSwitch) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
...
static int
hyperv_GENERIC_DomainDefParseEthernet(virDomainPtr domain, virDomainDefPtr def,
        Msvm_SyntheticEthernetPortSettingData_V_GENERIC_ *nets)
{
    int result = -1;
    Msvm_SyntheticEthernetPortSettingData_V_GENERIC_ *entry = nets;
    hypervPrivate *priv = domain->conn->privateData;

    while (entry != NULL) {
        if (entry->data->ResourceType ==
                MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_ETHERNET_ADAPTER) {
            if (hyperv_GENERIC_DomainDefParseSyntheticEthernetAdapter(def, entry, priv) < 0)
                goto cleanup;
        }
        entry = entry->next;
    }
...
static int
hyperv_GENERIC_DomainDefParseSerial(virDomainPtr domain ATTRIBUTE_UNUSED,
        virDomainDefPtr def, Msvm_ResourceAllocationSettingData_V_GENERIC_ *rasd)
{
    int result = -1;
    int port_num = 0;
    char **conn = NULL;
    ...
    while (entry != NULL) {
        if (entry->data->ResourceType ==
                MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_SERIAL_PORT) {
            /* clear some vars */
            serial = NULL;
            port_num = 0;
            conn = NULL;
...
static int
hyperv_GENERIC_DomainAttachSyntheticEthernetAdapter(virDomainPtr domain,
        virDomainNetDefPtr net, char *hostname)
{
    ...
    virBuffer query = VIR_BUFFER_INITIALIZER;
    Msvm_ComputerSystem_V_GENERIC_ *computer = NULL;
     ...
     */
    virBufferAddLit(&query, MSVM_VIRTUALSWITCH_V_GENERIC__WQL_SELECT);
    ...
    if (hyperv_GENERIC_InvokeMethod(priv, params, 4, "CreateSwitchPort",
                MSVM_VIRTUALSWITCHMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI,
    ...
    if (hyperv_GENERIC_MsvmComputerSystemFromDomain(domain, &computer) < 0)
        goto cleanup;
    ...
    ResourceSettingData.instanceName = MSVM_SYNTHETICETHERNETPORTSETTINGDATA_V_GENERIC__CLASSNAME;
    ...
    /* invoke */
    if (hyperv_GENERIC_InvokeMethod(priv, params, 2, "AddVirtualSystemResources",
                MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI,
...
static int
hyperv_GENERIC_DomainAttachSerial(virDomainPtr domain, virDomainChrDefPtr serial)
{
    int result = -1;
    ...
    Msvm_VirtualSystemSettingData_V_GENERIC_ *vssd = NULL;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *rasd = NULL;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *entry = NULL;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    ...
    if (hyperv_GENERIC_GetVSSDFromUUID(priv, uuid_string, &vssd) < 0)
        goto cleanup;

    if (hyperv_GENERIC_GetRASDByVSSDInstanceId(priv, vssd->data->InstanceID, &rasd) < 0)
        goto cleanup;
    ...
    /* build Msvm_ComputerSystem_V_GENERIC_ ref */
    virBufferAddLit(&query, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_SELECT);
    virBufferAsprintf(&query, "where Name = \"%s\"", uuid_string);
    ComputerSystem_REF.query = &query;
    ComputerSystem_REF.wmiProviderURI = ROOT_VIRTUALIZATION;
    ...
    ResourceSettingData.instanceName = MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__CLASSNAME;
    ...
    if (hyperv_GENERIC_InvokeMethod(priv, params, 2, "ModifyVirtualSystemResources",
                MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI,
                selector, NULL) < 0) {
...
static int
hyperv_GENERIC_DomainCreateSCSIController(virDomainPtr domain)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    const char *selector =
 ...
 */
static int
hyperv_GENERIC_DomainAttachStorageExtent(virDomainPtr domain, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *controller, const char *hostname)
{
    int result = -1;
    const char *selector =
        "CreationClassName=Msvm_VirtualSystemManagementService";
    ...
    embeddedparam1.instanceName = MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__CLASSNAME;
    ...
    settings_instance_id = hyperv_GENERIC_GetInstanceIDFromXMLResponse(response);
    ...
    embeddedparam2.instanceName = MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__CLASSNAME;
...
static int
hyperv_GENERIC_DomainAttachPhysicalDisk(virDomainPtr domain, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *controller, const char *hostname)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    ...
    embeddedparam.instanceName = MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__CLASSNAME;
...
static int
hyperv_GENERIC_DomainAttachCDROM(virDomainPtr domain, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *controller, const char *hostname)
{
    int result = -1;
    const char *selector =
...
static int
hyperv_GENERIC_DomainAttachFloppy(virDomainPtr domain, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *driveSettings, const char *hostname)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    const char *selector =
...
static int
hyperv_GENERIC_DomainAttachStorageVolume(virDomainPtr domain, virDomainDiskDefPtr disk,
        Msvm_ResourceAllocationSettingData_V_GENERIC_ *controller, const char *hostname)
{
    switch (disk->device) {
        case VIR_DOMAIN_DISK_DEVICE_DISK:
            return hyperv_GENERIC_DomainAttachStorageExtent(domain, disk, controller,
                    hostname);
        case VIR_DOMAIN_DISK_DEVICE_LUN:
            return hyperv_GENERIC_DomainAttachPhysicalDisk(domain, disk, controller,
                    hostname);
        case VIR_DOMAIN_DISK_DEVICE_CDROM:
            return hyperv_GENERIC_DomainAttachCDROM(domain, disk, controller, hostname);
        default:
...
static int
hyperv_GENERIC_DomainAttachStorage(virDomainPtr domain, virDomainDefPtr def,
        const char *hostname)
{
    int result = -1;
    ...
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *ideControllers[HYPERV_MAX_IDE_CONTROLLERS];
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *scsiControllers[HYPERV_MAX_SCSI_CONTROLLERS];
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *floppySettings = NULL;
    ...
    for (i = 0; i < def->ncontrollers; i++) {
        if (def->controllers[i]->type == VIR_DOMAIN_CONTROLLER_TYPE_SCSI) {
            ...
            if (hyperv_GENERIC_DomainCreateSCSIController(domain) < 0)
                goto cleanup;
        }
    }
    ...
    while (entry != NULL) {
        switch (entry->data->ResourceType) {
            ...
            case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_PARALLEL_SCSI_HBA:
                ...
                break;
            case MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_FLOPPY:
    ...
    for (i = 0; i < def->ndisks; i++) {
        ...
        switch(def->disks[i]->bus) {
            case VIR_DOMAIN_DISK_BUS_IDE:
                /* ide disk */
                if (hyperv_GENERIC_DomainAttachStorageVolume(domain, def->disks[i],
            ...
            case VIR_DOMAIN_DISK_BUS_FDC:
                /* floppy disk */
                if (hyperv_GENERIC_DomainAttachFloppy(domain, def->disks[i],
...
const char *
hyperv_GENERIC_ConnectGetType(virConnectPtr conn ATTRIBUTE_UNUSED)
{
    return "Hyper-V";
}

int
hyperv_GENERIC_ConnectGetVersion(virConnectPtr conn, unsigned long *version)
{
    int result = -1;
...
char *
hyperv_GENERIC_ConnectGetHostname(virConnectPtr conn)
{
    char *hostname = NULL;
    hypervPrivate *priv = conn->privateData;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    ...
    if (hyperv_GENERIC_GetPhysicalSystemList(priv, &computerSystem) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_ConnectGetMaxVcpus(virConnectPtr conn, const char *type ATTRIBUTE_UNUSED)
{
    int result = -1;
    hypervPrivate *priv = conn->privateData;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    Msvm_ProcessorSettingData_V_GENERIC_ *processorSettingData = NULL;
    ...
    if (hyperv_GENERIC_GetMsvmProcessorSettingDataList(priv, &query,
...
int
hyperv_GENERIC_NodeGetInfo(virConnectPtr conn, virNodeInfoPtr info)
{
    int result = -1;
    hypervPrivate *priv = conn->privateData;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    ...
    if (hyperv_GENERIC_GetProcessorsByName(priv, computerSystem->data->Name,
                &processorList) < 0) {
        goto cleanup;
    }
...
int
hyperv_GENERIC_ConnectListDomains(virConnectPtr conn, int *ids, int maxids)
{
    bool success = false;
    hypervPrivate *priv = conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystemList = NULL;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    int count = 0;

    if (maxids == 0)
        return 0;

    if (hyperv_GENERIC_GetActiveVirtualSystemList(priv, &computerSystemList) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_ConnectNumOfDomains(virConnectPtr conn)
{
    bool success = false;
    hypervPrivate *priv = conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystemList = NULL;
...
virDomainPtr
hyperv_GENERIC_DomainCreateXML(virConnectPtr conn, const char *xmlDesc,
        unsigned int flags)
{
    virDomainPtr domain;
    ...
    domain = hyperv_GENERIC_DomainDefineXML(conn, xmlDesc);
    if (domain == NULL)
        return NULL;

    /* start the domain */
    if (hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange(domain,
                MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_ENABLED) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR,
    ...
    if (flags & VIR_DOMAIN_START_PAUSED) {
        /* TODO: use hyperv_GENERIC_DomainSuspend to implement this */
    }
...
virDomainPtr
hyperv_GENERIC_DomainLookupByID(virConnectPtr conn, int id)
{
    virDomainPtr domain = NULL;
    hypervPrivate *priv = conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;

    if (hyperv_GENERIC_GetVirtualSystemByID(priv, id, &computerSystem) < 0) {
        virReportError(VIR_ERR_NO_DOMAIN, _("No domain with ID %d"), id);
        goto cleanup;
    }

    hyperv_GENERIC_MsvmComputerSystemToDomain(conn, computerSystem, &domain);
...
virDomainPtr
hyperv_GENERIC_DomainLookupByUUID(virConnectPtr conn, const unsigned char *uuid)
{
    virDomainPtr domain = NULL;
    hypervPrivate *priv = conn->privateData;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    ...
    if (hyperv_GENERIC_GetVirtualSystemByUUID(priv, uuid_string, &computerSystem) < 0) {
        virReportError(VIR_ERR_NO_DOMAIN,
                       _("No domain with UUID %s"), uuid_string);
        goto cleanup;
    }
...
virDomainPtr
hyperv_GENERIC_DomainLookupByName(virConnectPtr conn, const char *name)
{
    virDomainPtr domain = NULL;
    hypervPrivate *priv = conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;

    if (hyperv_GENERIC_GetVirtualSystemByName(priv, name, &computerSystem) < 0) {
...
int
hyperv_GENERIC_DomainSuspend(virDomainPtr domain)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;

    if (hyperv_GENERIC_MsvmComputerSystemFromDomain(domain, &computerSystem) < 0)
        goto cleanup;

    if (computerSystem->data->EnabledState !=
        MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_ENABLED) {
        virReportError(VIR_ERR_OPERATION_INVALID, "%s",
                       _("Domain is not active"));
        goto cleanup;
    }

    result = hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange
               (domain, MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_PAUSED);
...
int
hyperv_GENERIC_DomainResume(virDomainPtr domain)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    if (computerSystem->data->EnabledState !=
        MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_PAUSED) {
        virReportError(VIR_ERR_OPERATION_INVALID, "%s",
    ...
    result = hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange
               (domain, MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_ENABLED);
...
int
hyperv_GENERIC_DomainShutdown(virDomainPtr domain)
{
    return hyperv_GENERIC_DomainShutdownFlags(domain, 0);
}

int
hyperv_GENERIC_DomainShutdownFlags(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    if (!hyperv_GENERIC_IsMsvmComputerSystemActive(computerSystem, &in_transition) || in_transition) {
        virReportError(VIR_ERR_OPERATION_INVALID, "%s",
                _("Domain is not active or in state transition"));
        goto cleanup;
    }

    result = hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange(domain,
            MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_ENABLED);
...
int
hyperv_GENERIC_DomainReboot(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    result = hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange(domain,
            MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_REBOOT);
...
int
hyperv_GENERIC_DomainDestroyFlags(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    if (!hyperv_GENERIC_IsMsvmComputerSystemActive(computerSystem, &in_transition) ||
        in_transition) {
        virReportError(VIR_ERR_OPERATION_INVALID, "%s",
                       _("Domain is not active or is in state transition"));
        goto cleanup;
    ...
    result = hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange
               (domain, MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_DISABLED);
...
int
hyperv_GENERIC_DomainDestroy(virDomainPtr domain)
{
    return hyperv_GENERIC_DomainDestroyFlags(domain, 0);
}

char *
hyperv_GENERIC_DomainGetOSType(virDomainPtr domain ATTRIBUTE_UNUSED)
{
    char *osType;
...
unsigned long long
hyperv_GENERIC_DomainGetMaxMemory(virDomainPtr domain)
{
    unsigned long long result = 0;
    bool success = false;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    Msvm_VirtualSystemSettingData_V_GENERIC_ *vssd = NULL;
    Msvm_MemorySettingData_V_GENERIC_ *mem_sd = NULL;
    hypervPrivate *priv = domain->conn->privateData;
    ...
    if (hyperv_GENERIC_GetMemSDByVSSDInstanceId(priv, vssd->data->InstanceID,
                &mem_sd) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_DomainSetMaxMemory(virDomainPtr domain, unsigned long memory)
{
    int result = -1;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    invokeXmlParam *params = NULL;
    ...
    result = hyperv_GENERIC_InvokeMethod(priv, params, 2, "ModifyVirtualSystemResources",
        MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI, selector, NULL);
...
int
hyperv_GENERIC_DomainSetMemory(virDomainPtr domain, unsigned long memory)
{
    return hyperv_GENERIC_DomainSetMemoryFlags(domain, memory, 0);
}

int
hyperv_GENERIC_DomainSetMemoryFlags(virDomainPtr domain, unsigned long memory,
...
int
hyperv_GENERIC_DomainGetInfo(virDomainPtr domain, virDomainInfoPtr info)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    Msvm_VirtualSystemSettingData_V_GENERIC_ *virtualSystemSettingData = NULL;
    Msvm_ProcessorSettingData_V_GENERIC_ *processorSettingData = NULL;
    Msvm_MemorySettingData_V_GENERIC_ *memorySettingData = NULL;

    memset(info, 0, sizeof(*info));

    virUUIDFormat(domain->uuid, uuid_string);

    /* Get Msvm_ComputerSystem_V_GENERIC_ */
    if (hyperv_GENERIC_MsvmComputerSystemFromDomain(domain, &computerSystem) < 0)
        goto cleanup;

    if (hyperv_GENERIC_GetVSSDFromUUID(priv, uuid_string,
    ...
    if (hyperv_GENERIC_GetProcSDByVSSDInstanceId(priv,
    ...
    if (hyperv_GENERIC_GetMemSDByVSSDInstanceId(priv,
                virtualSystemSettingData->data->InstanceID,
                &memorySettingData) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR,
                       _("Could not lookup %s for domain %s"),
    ...
    /* Fill struct */
    info->state = hyperv_GENERIC_MsvmComputerSystemEnabledStateToDomainState(computerSystem);
...
int
hyperv_GENERIC_DomainGetState(virDomainPtr domain, int *state, int *reason,
                     unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    ...
    *state = hyperv_GENERIC_MsvmComputerSystemEnabledStateToDomainState(computerSystem);
...
char *
hyperv_GENERIC_DomainScreenshot(virDomainPtr domain, virStreamPtr stream,
        unsigned int screen ATTRIBUTE_UNUSED, unsigned int flags ATTRIBUTE_UNUSED)
{
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    hypervPrivate *priv = domain->conn->privateData;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    Msvm_VideoHead_V_GENERIC_ *heads = NULL;
    Msvm_SyntheticDisplayController_V_GENERIC_ *ctrlr = NULL;
    eprParam eprparam;
    ...
    if (hyperv_GENERIC_GetMsvmSyntheticDisplayControllerList(priv, &query, &ctrlr) < 0)
        goto thumbnail;
    ...
    if (hyperv_GENERIC_GetMsvmVideoHeadList(priv, &query, &heads) < 0)
        goto thumbnail;
...
thumbnail:
    /* Prepare EPR param - get Msvm_VirtualSystemSettingData_V_GENERIC_ */
    virBufferFreeAndReset(&query);
    virBufferAsprintf(&query,
            "associators of "
            "{Msvm_ComputerSystem.CreationClassName=\"Msvm_ComputerSystem\","
    ...
    if (hyperv_GENERIC_InvokeMethod(priv, params, 3, "GetVirtualSystemThumbnailImage",
                MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI, selector,
                &ret_doc) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_DomainSetVcpus(virDomainPtr domain, unsigned int nvcpus)
{
    return hyperv_GENERIC_DomainSetVcpusFlags(domain, nvcpus, 0);
}

int
hyperv_GENERIC_DomainSetVcpusFlags(virDomainPtr domain, unsigned int nvcpus,
        unsigned int flags ATTRIBUTE_UNUSED)
{
    int result = -1;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    const char *selector =
        "CreationClassName=Msvm_VirtualSystemManagementService";
    Msvm_VirtualSystemSettingData_V_GENERIC_ *vssd = NULL;
    Msvm_ProcessorSettingData_V_GENERIC_ *proc_sd = NULL;
    hypervPrivate *priv = domain->conn->privateData;
    eprParam eprparam;
    embeddedParam embeddedparam;
    ...
    if (hyperv_GENERIC_GetProcSDByVSSDInstanceId(priv, vssd->data->InstanceID,
                &proc_sd) < 0) {
        goto cleanup;
    }

    /* prepare parameters */
    virBufferAddLit(&buf, MSVM_COMPUTERSYSTEM_V_GENERIC__WQL_SELECT);
    ...
    if (hyperv_GENERIC_InvokeMethod(priv, params, 2, "ModifyVirtualSystemResources",
                MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI, selector, NULL) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_DomainGetVcpusFlags(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    hypervPrivate *priv = domain->conn->privateData;
    ...
    /* Start by getting the Msvm_ComputerSystem_V_GENERIC_ */
    if (hyperv_GENERIC_MsvmComputerSystemFromDomain(domain, &computerSystem) < 0) {
        goto cleanup;
    }
    ...
    if (flags & VIR_DOMAIN_VCPU_LIVE) {
        if (computerSystem->data->EnabledState != MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_ENABLED) {
    ...
    if (flags & VIR_DOMAIN_VCPU_MAXIMUM) {
        result = hyperv_GENERIC_ConnectGetMaxVcpus(domain->conn, NULL);
        goto cleanup;
    }
...
int
hyperv_GENERIC_DomainGetVcpus(virDomainPtr domain, virVcpuInfoPtr info, int maxinfo,
...
int
hyperv_GENERIC_DomainGetMaxVcpus(virDomainPtr dom)
{
    /* If the guest is inactive, this is basically the same as virConnectGetMaxVcpus() */
    return (hyperv_GENERIC_DomainIsActive(dom)) ?
        hyperv_GENERIC_DomainGetVcpusFlags(dom, (VIR_DOMAIN_VCPU_LIVE | VIR_DOMAIN_VCPU_MAXIMUM))
        : hyperv_GENERIC_ConnectGetMaxVcpus(dom->conn, NULL);
}

char *
hyperv_GENERIC_DomainGetXMLDesc(virDomainPtr domain, unsigned int flags)
{
    char *xml = NULL;
    hypervPrivate *priv = domain->conn->privateData;
    ...
    Msvm_MemorySettingData_V_GENERIC_ *memorySettingData = NULL;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *rasd = NULL;
    Msvm_SyntheticEthernetPortSettingData_V_GENERIC_ *nets = NULL;
    ...
    /* Get Msvm_ResourceAllocationSettingData_V_GENERIC_ */
    if (hyperv_GENERIC_GetRASDByVSSDInstanceId(priv,
                virtualSystemSettingData->data->InstanceID,
                &rasd) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR,
    ...
    /* Get Msvm_SyntheticEthernetPortSettingData_V_GENERIC_ */
    if (hyperv_GENERIC_GetSyntheticEthernetPortSDByVSSDInstanceId(priv,
                virtualSystemSettingData->data->InstanceID,
                &nets) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR,
    ...
    if (hyperv_GENERIC_DomainDefParseStorage(domain, def, rasd) < 0)
        goto cleanup;

    if (hyperv_GENERIC_DomainDefParseSerial(domain, def, rasd) < 0)
        goto cleanup;

    if (hyperv_GENERIC_DomainDefParseEthernet(domain, def, nets) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_ConnectListDefinedDomains(virConnectPtr conn, char **const names,
        int maxnames)
{
    bool success = false;
    hypervPrivate *priv = conn->privateData;
    ...
    if (hyperv_GENERIC_GetInactiveVirtualSystemList(priv, &computerSystemList) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_ConnectNumOfDefinedDomains(virConnectPtr conn)
{
    bool success = false;
    hypervPrivate *priv = conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystemList = NULL;
...
int
hyperv_GENERIC_DomainCreateWithFlags(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
...
int
hyperv_GENERIC_DomainCreate(virDomainPtr domain)
{
    return hyperv_GENERIC_DomainCreateWithFlags(domain, 0);
}

virDomainPtr
hyperv_GENERIC_DomainDefineXML(virConnectPtr conn, const char *xml)
{
    hypervPrivate *priv = conn->privateData;
    virDomainDefPtr def = NULL;
    virDomainPtr domain = NULL;
    ...
    Msvm_ComputerSystem_V_GENERIC_ *host = NULL;
    int i = 0;
    int nb_params;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    const char *selector =
    ...
    if (hyperv_GENERIC_GetHostSystem(priv, &host) < 0)
        goto cleanup;
    ...
    if (def->uuid == NULL ||
            (domain = hyperv_GENERIC_DomainLookupByUUID(conn, def->uuid)) == NULL) {
        ...
        if (hyperv_GENERIC_InvokeMethod(priv, params, nb_params, "DefineVirtualSystem",
                    MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI,
                    selector, NULL) < 0) {
            virReportError(VIR_ERR_INTERNAL_ERROR,
        ...
        domain = hyperv_GENERIC_DomainLookupByName(conn, def->name);
    }

    /* set domain vcpus */
    if (def->vcpus) {
        if (hyperv_GENERIC_DomainSetVcpus(domain, def->maxvcpus) < 0) {
            virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
    ...
    if (def->mem.max_memory > 0) {
        if (hyperv_GENERIC_DomainSetMaxMemory(domain, def->mem.max_memory) < 0) {
            virReportError(VIR_ERR_INTERNAL_ERROR,
    ...
    if (def->mem.cur_balloon > 0) {
        if (hyperv_GENERIC_DomainSetMemory(domain, def->mem.cur_balloon) < 0) {
            virReportError(VIR_ERR_INTERNAL_ERROR,
    ...
    for (i = 0; i < def->nnets; i++) {
        if (hyperv_GENERIC_DomainAttachSyntheticEthernetAdapter(domain, def->nets[i],
                    hostname) < 0) {
            virReportError(VIR_ERR_INTERNAL_ERROR,
    ...
    for (i = 0; i < def->nserials; i++) {
        if (hyperv_GENERIC_DomainAttachSerial(domain, def->serials[i]) < 0) {
    ...
    /* Attach all storage */
    if (hyperv_GENERIC_DomainAttachStorage(domain, def, hostname) < 0) {
...
cleanup:
    ...
    if (success) {
        ...
        ignore_value(hyperv_GENERIC_DomainUndefine(domain));
        return NULL;
    }
}

int
hyperv_GENERIC_DomainUndefine(virDomainPtr domain)
{
    return hyperv_GENERIC_DomainUndefineFlags(domain, 0);
}

int
hyperv_GENERIC_DomainUndefineFlags(virDomainPtr domain, unsigned int flags ATTRIBUTE_UNUSED)
{
    int result = -1;
    const char *selector =
        "CreationClassName=Msvm_VirtualSystemManagementService";
    ...
    if (computerSystem->data->EnabledState != MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_DISABLED) {
        if (hyperv_GENERIC_DomainShutdown(domain) < 0)
            goto cleanup;
    }
    ...
    if (hyperv_GENERIC_InvokeMethod(priv, params, 1, "DestroyVirtualSystem",
                MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI, selector, NULL) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
...
int
hyperv_GENERIC_DomainAttachDevice(virDomainPtr domain, const char *xml)
{
    return hyperv_GENERIC_DomainAttachDeviceFlags(domain, xml, 0);
}

int
hyperv_GENERIC_DomainAttachDeviceFlags(virDomainPtr domain, const char *xml,
        unsigned int flags ATTRIBUTE_UNUSED)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    ...
    char *hostname = NULL;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *controller = NULL;
    Msvm_ResourceAllocationSettingData_V_GENERIC_ *rasd = NULL, *entry = NULL;
    Msvm_VirtualSystemSettingData_V_GENERIC_ *vssd = NULL;
    int num_scsi = 0;
    ...
    if ((xmlDomain = hyperv_GENERIC_DomainGetXMLDesc(domain, 0)) == NULL)
        goto cleanup;
    ...
    switch(dev->type) {
        case VIR_DOMAIN_DEVICE_DISK:
             ...
             * in hyperv_GENERIC_DomainAttachStorage(). This code tries to perform in the
            ...
            switch(dev->data.disk->bus) {
                case VIR_DOMAIN_DISK_BUS_IDE:
                    while (entry != NULL) {
                        if (entry->data->ResourceType ==
                                MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_IDE_CONTROLLER) {
                ...
                case VIR_DOMAIN_DISK_BUS_SCSI:
                    while (entry != NULL) {
                        if (entry->data->ResourceType ==
                                MSVM_RESOURCEALLOCATIONSETTINGDATA_V_GENERIC__RESOURCETYPE_PARALLEL_SCSI_HBA) {
                            if (num_scsi++ ==
                                    dev->data.disk->info.addr.drive.controller) {
                                controller = entry;
                                break;
            ...
            if (hyperv_GENERIC_DomainAttachStorageVolume(domain, dev->data.disk,
                        controller, hostname) < 0)
                goto cleanup;
            break;
        case VIR_DOMAIN_DEVICE_NET:
            if (hyperv_GENERIC_DomainAttachSyntheticEthernetAdapter(domain, dev->data.net,
                        hostname) < 0)
                goto cleanup;
            break;
        case VIR_DOMAIN_DEVICE_CHR:
            if (hyperv_GENERIC_DomainAttachSerial(domain, dev->data.chr) < 0)
                goto cleanup;
        default:
...
int
hyperv_GENERIC_DomainGetAutostart(virDomainPtr domain, int *autostart)
{
    int result = -1;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_VirtualSystemGlobalSettingData_V_GENERIC_ *vsgsd = NULL;
    virBuffer query = VIR_BUFFER_INITIALIZER;


    virUUIDFormat(domain->uuid, uuid_string);
    virBufferAddLit(&query, MSVM_VIRTUALSYSTEMGLOBALSETTINGDATA_V_GENERIC__WQL_SELECT);
    virBufferAsprintf(&query, "where SystemName = \"%s\"", uuid_string);

    if (hyperv_GENERIC_GetMsvmVirtualSystemGlobalSettingDataList(priv, &query,
                &vsgsd) < 0)
        goto cleanup;
...
int
hyperv_GENERIC_DomainSetAutostart(virDomainPtr domain, int autostart)
{
    int result = -1;
    invokeXmlParam *params = NULL;
    hypervPrivate *priv = domain->conn->privateData;
    ...
    result = hyperv_GENERIC_InvokeMethod(priv, params, 2, "ModifyVirtualSystem",
            MSVM_VIRTUALSYSTEMMANAGEMENTSERVICE_V_GENERIC__RESOURCE_URI, selector, NULL);
...
char *
hyperv_GENERIC_DomainGetSchedulerType(virDomainPtr domain ATTRIBUTE_UNUSED, int *nparams)
{
    char *type;
...
int
hyperv_GENERIC_DomainGetSchedulerParameters(virDomainPtr domain,
        virTypedParameterPtr params, int *nparams)
{
    return hyperv_GENERIC_DomainGetSchedulerParametersFlags(domain, params, nparams,
            VIR_DOMAIN_AFFECT_CURRENT);
}

int
hyperv_GENERIC_DomainGetSchedulerParametersFlags(virDomainPtr domain,
...
unsigned long long
hyperv_GENERIC_NodeGetFreeMemory(virConnectPtr conn)
{
...
int
hyperv_GENERIC_DomainIsActive(virDomainPtr domain)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    result = hyperv_GENERIC_IsMsvmComputerSystemActive(computerSystem, NULL) ? 1 : 0;
...
int
hyperv_GENERIC_DomainManagedSave(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    result = hyperv_GENERIC_InvokeMsvmComputerSystemRequestStateChange
               (domain, MSVM_COMPUTERSYSTEM_V_GENERIC__REQUESTEDSTATE_SUSPENDED);
...
int
hyperv_GENERIC_DomainHasManagedSaveImage(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    result = computerSystem->data->EnabledState ==
             MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_SUSPENDED ? 1 : 0;
...
int
hyperv_GENERIC_DomainManagedSaveRemove(virDomainPtr domain, unsigned int flags)
{
    int result = -1;
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    ...
    if (computerSystem->data->EnabledState !=
        MSVM_COMPUTERSYSTEM_V_GENERIC__ENABLEDSTATE_SUSPENDED) {
        virReportError(VIR_ERR_OPERATION_INVALID, "%s",
        ...
        int nkeycodes, unsigned int flags ATTRIBUTE_UNUSED)
{
    ...
    hypervPrivate *priv = domain->conn->privateData;
    Msvm_ComputerSystem_V_GENERIC_ *computerSystem = NULL;
    Msvm_Keyboard_V_GENERIC_ *keyboards = NULL;
    invokeXmlParam *params = NULL;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    char uuid_string[VIR_UUID_STRING_BUFLEN];
    ...
    if (hyperv_GENERIC_GetMsvmKeyboardList(priv, &query, &keyboards) < 0) {
        virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
    ...
    for (i = 0; i < nkeycodes; i++) {
        ...
        if (hyperv_GENERIC_InvokeMethod(priv, params, 1, "TypeKey",
                    MSVM_KEYBOARD_V_GENERIC__RESOURCE_URI, selector, NULL) < 0) {
...
int
hyperv_GENERIC_ConnectListAllDomains(virConnectPtr conn, virDomainPtr **domains,
        unsigned int flags)
{
    hypervPrivate *priv = conn->privateData;
    virBuffer query = VIR_BUFFER_INITIALIZER;
    ...
    if (hyperv_GENERIC_GetMsvmComputerSystemList(priv, &query,
    ...
    for (computerSystem = computerSystemList; computerSystem != NULL;
        ...
        if (MATCH(VIR_CONNECT_LIST_DOMAINS_FILTERS_STATE)) {
            int st = hyperv_GENERIC_MsvmComputerSystemEnabledStateToDomainState(computerSystem);
        ...
        if (hyperv_GENERIC_MsvmComputerSystemToDomain(conn, computerSystem,
                                             &domain) < 0)
            goto cleanup;
