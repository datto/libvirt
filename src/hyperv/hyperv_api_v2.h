...
enum _Msvm_EthernetPortAllocationSettingData_v2_EnabledState {
    MSVM_ETHERNETPORTALLOCATIONSETTINGDATA_V2_ENABLEDSTATE_ENABLED = 2,
    MSVM_ETHERNETPORTALLOCATIONSETTINGDATA_V2_ENABLEDSTATE_DISABLED = 3,
};
