...
enum _Msvm_ComputerSystem_v2_RequestedState {
    ...
    MSVM_COMPUTERSYSTEM_V2_REQUESTEDSTATE_REBOOT = 10,
    MSVM_COMPUTERSYSTEM_V2_REQUESTEDSTATE_PAUSED = 32768,
    MSVM_COMPUTERSYSTEM_V2_REQUESTEDSTATE_SUSPENDED = 32769,
};

enum _Msvm_ConcreteJob__v2_JobState {
